...
INSERT INTO comments (id, comment, username, author_name, date, article_id, user_id)
VALUES
    (1, 'such a great article!', 'user5', 'Warm Milk', 1, 5),
    (2, 'loved the read!', 'user1', 'Mike Sherman', 2, 1),
    (3, 'Powerful', 'user4', 'Stan Francisco', 3, 4),
    (4, 'This reminds me of a similar experience I had', 'user3', 'Joe Perry', 4, 3),
    (5, 'Hey!', 'user2', 'Deb Straus', 5, 2)
