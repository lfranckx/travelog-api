...
VALUES
    ("user1@email.com", "user1", "User1234", "Mike", "Sherman", "https://loremflickr.com/750/300/paris,girl/random=1"),
    ("user2@email.com", "user2", "User1234", "Deb", "Straus", "https://loremflickr.com/750/300/paris,girl/random=2"),
    ("user3@email.com", "user3", "User1234", "Joe", "Perry", "https://loremflickr.com/750/300/paris,girl/random=3"),
    ("user4@email.com", "user4", "User1234", "Stan", "Francisco", "https://loremflickr.com/750/300/paris,girl/random=4"),
    ("user5@email.com", "user5", "User1234", "Warm", "Milk", "https://loremflickr.com/750/300/paris,girl/random=5");
